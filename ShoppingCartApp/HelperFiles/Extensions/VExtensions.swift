...
extension UILabel {
    func setHtml(string: String) {
        ...
        do {
            ...
            attText.addAttribute(NSFontAttributeName, value: self.font, range: NSMakeRange(0, attText.length))
            attText.addAttribute(NSForegroundColorAttributeName, value: self.textColor, range: NSMakeRange(0, attText.length))
...
func degree(radian: CGFloat)-> CGFloat {
    return CGFloat((180 *  Double(radian)) / M_PI)
}
